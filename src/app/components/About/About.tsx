  ...
  return (
    <section className="w-full py-16">
      <div className="container mx-auto flex flex-col lg:flex-row items-start px-4 lg:px-0">
        <div className="w-full lg:w-1/3 mb-10 lg:mb-0 flex flex-col items-end">
          ...
          <div className=" flex flex-col lg:flex-row">
            ...
            <ul className="space-y-4 text-lg text-gray-700">
              ...
              <li>Laveton, Victoria, Australia</li>
            </ul>
          </div>
        </div>

        <div className="w-full lg:w-2/3 lg:pl-12">
          <h3 className="text-3xl font-bold mb-10">Hello There!</h3>
